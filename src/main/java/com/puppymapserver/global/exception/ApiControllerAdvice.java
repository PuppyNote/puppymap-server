...
import com.puppymapserver.jwt.exception.JwtTokenException;
...
public class ApiControllerAdvice {
	 ...
	 */
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler(PuppyMapException.class)
	public ApiResponse<Object> PuppyMapException(PuppyMapException e) {
		log.error(e.getMessage());
		return ApiResponse.of(
			HttpStatus.BAD_REQUEST,
			e.getMessage(),
